...
test('given: invalid date, when: event is created, then: an error is thrown', () => {
    ...
    // when
    const newEvent = () => {
        new Event({ name, description, date: invalidEndDate, location, category, backgroundImage: "", isTrending: false })
    };
    // then
...
test('Given: event with no id, when: wanting to call event with getId, then: error is thrown.', () => {
    // Given
    const event = new Event({ name, description, date, location, category, backgroundImage: "", isTrending: false });
...
test('Given: event with empty name, When: event is created, Then: an error is thrown', () => {
    ...
    // When
    const createEvent = () => {
        new Event({ name: emptyName, description, date, location, category, backgroundImage: "", isTrending: false });
    };
...
test('Given: event with empty description, When: event is created, Then: an error is thrown', () => {
    ...
    // When
    const createEvent = () => {
        new Event({ name, description: emptyDescription, date, location, category, backgroundImage: "", isTrending: false });
    };
...
test('Given: event with empty location, When: event is created, Then: an error is thrown', () => {
    ...
    // When
    const createEvent = () => {
        new Event({ name, description, date, location: emptyLocation, category, backgroundImage: "", isTrending: false });
    };
...
test('Given: event with empty category, When: event is created, Then: an error is thrown', () => {
    ...
    // When
    const createEvent = () => {
        new Event({ name, description, date, location, category: emptyCategory, backgroundImage: "", isTrending: false });
    };
